...
func E2EConcurrentAndSaveFixtures() {
	setUp("info")
	...
	for {
		...
		case save := <-endCh:
			...
			if err != nil {
				...
				tryWriteFixtureFile(index, save)
			}
...
func tryWriteFixtureFile(index int, data LocalPartySaveData) {
